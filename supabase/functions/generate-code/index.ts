    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: "system", 
            content: `You are an expert programmer. Generate clean, well-commented, production-ready code based on user requests. 
            
Rules:
- Return ONLY the code, no explanations before or after
- Include helpful comments within the code
- Use modern best practices and patterns
- If the language isn't specified, use TypeScript/JavaScript
- Format the code properly with consistent indentation` 
          },
    ...
    // Clean up code blocks if the model wraps them
